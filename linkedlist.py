...
class LinkedList(object):
    ...
    def length(self):
        ...
        Best and worst case running time: O(1) returns a value[TODO]"""
    ...
    def append(self, item):
        ...
        Best and worst case running time: O(1) because we have acess to tail, nothing else needs to change"""
